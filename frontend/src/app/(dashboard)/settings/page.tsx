...
className="rounded border-gray-300 dark:border-border text-brand focus:ring-brand disabled:opacity-50 disabled:cursor-not-allowed"
                />
...
className="mt-0.5 rounded border-gray-300 dark:border-border text-brand focus:ring-brand disabled:opacity-50 disabled:cursor-not-allowed"
                  />
                  <div>
